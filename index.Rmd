...
Ce sript requiert l'utilisation des *Packages* (librairies) suivants. Il est fort probable que certain ne soient pas installés par défault, vous devrez donc utiliser l'onglet `Packages` afin de les installer. 
...
Je vous encourage maintenant à ouvrir ce tableau de le comparer la disposition des données avec notre tableau original. 
...
## Exercices 2 - Générer le même heatmap mais avec uniquement vos trois inconnus 
